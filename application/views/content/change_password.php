...
<body>
    <form class="form-signin" method="post" action="<?php echo base_url();?>Intro/ProcessChangePassword">
    	<span id="qr-logo-span"><i class="fa fa-qrcode" id="qr-black-logo"></i></span>
        <h2 class="form-signin-heading text-header">Insert Your New Password</h2>
        <?php if($alert != ""){ ?>
            <div class="alert">
        ...
        <span class="input input--haruki">
            <input class="input__field input__field--haruki" type="password" id="input-1" name="password" required="required" />
            <label class="input__label input__label--haruki" for="input-1">
                <span class="input__label-content input__label-content--haruki">New Password</span>
            </label>
        </span>
