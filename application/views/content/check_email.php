...
<body>
    <form class="form-signin" method="post" action="<?php echo base_url();?>Intro/ProcessCheckEmail">
    	<span id="qr-logo-span"><i class="fa fa-qrcode" id="qr-black-logo"></i></span>
        <h2 class="form-signin-heading text-header">Check You Account</h2>
        <?php if($alert != ""){ ?>
            <div class="alert">
        ...
        <span class="input input--haruki">
            <input class="input__field input__field--haruki" type="text" id="input-1" name="username" required="required" />
            <label class="input__label input__label--haruki" for="input-1">
                <span class="input__label-content input__label-content--haruki">Username</span>
            </label>
        </span>
        <span class="input input--haruki">
            <input class="input__field input__field--haruki" type="email" id="input-1" name="email" required="required" />
            <label class="input__label input__label--haruki" for="input-1">
                <span class="input__label-content input__label-content--haruki">Email</span>
            </label>
        </span>
        <button class="btn btn-lg btn-primary btn-block btn-submits" id="btn-submits" type="submit">Submit</button>
        <p id="register-href" >Already Got It Back? <a id="href" href="<?= base_url() ?>Intro/LoginForm">Login Now!</a></p>
    </form>
