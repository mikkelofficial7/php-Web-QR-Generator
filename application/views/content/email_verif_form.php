...
<body>
    <form class="form-signin" method="post" action="<?php echo base_url();?>Intro/ProcessEmailVerifyForm">
    	<span id="qr-logo-span"><i class="fa fa-qrcode" id="qr-black-logo"></i></span>
        <h2 class="form-signin-heading text-header">Insert Verification Code</h2>
        <?php if($alert != ""){ ?>
            <div class="alert">
        ...
        <span class="input input--haruki">
            <input class="input__field input__field--haruki" type="text" id="input-1" maxlength="6" name="verif" required="required" />
            <label class="input__label input__label--haruki" for="input-1">
                <span class="input__label-content input__label-content--haruki">Verification Code</span>
            </label>
        </span>
        <button class="btn btn-lg btn-primary btn-block btn-submits" id="btn-submits" type="submit">Verify</button>
    </form>
